...
import { Mail, Lock, Eye, EyeOff, LogIn, Award } from 'lucide-react';
...
const TeacherLoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (login) {
        login(response.data.user, 'teacher');
      }
            ...
            <div className="card-body p-8">
              <form onSubmit={handleSubmit}>
                <div className="space-y-4">
                  ...
                  <div className="text-right">
                    <a href="/teachers/forgot-password" className="link link-secondary text-sm">
                      Forgot password?
                    </a>
                  </div>
              ...
              <div className="text-center mt-6 pt-4 border-t border-base-200">
                <p className="text-sm text-base-content/60">
                  ...
                  <a href="/teachers/signup" className="link link-secondary font-medium">
                    Sign up here
                  </a>
                </p>
              </div>
